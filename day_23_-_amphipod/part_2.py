...
def amphipod_field_extension(amphipod_field: list[list[str]]) -> list[list[str]]:
	return [*amphipod_field[:3], (*"  #D#C#B#A#  ",), (*"  #D#B#A#C#  ",), *amphipod_field[3:]]
...
def amphipod_field_cost(amphipod_field: list[list[str]],cache: dict[str] = {}) -> int:
...
def solution(elements: list[list[str]]) -> int:
	return amphipod_field_cost(amphipod_field_extension(elements))
